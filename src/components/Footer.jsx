        ...
        <footer className="bg-dark text-white">
            <div className="px-4 lg:px-20 py-4 mt-3">
                <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between mt-10">
                    <a href="#" className="text-3xl font-bold mb-4 lg:mb-0">SMS<span className='text-yellow'>Padi</span> </a>
                    <div className="flex items-center space-x-4 lg:space-x-8">
                        <img src={Icon1} alt="telegram" className="object-contain w-10 h-10" />
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between px-4 lg:px-20 py-4 mt-3">
                <p className="text-xl mb-4 lg:mb-0">&copy; All rights reserved. SMSPadi 2023.</p>
            ...
            <div className="text-center px-4 lg:px-20 py-4">
                ...
                <p className="text-slate-gray">Phone numbers obtained from our service must not be used for any illegal purpose. It is forbidden to use phone numbers, including, but not limited to: for sites with a high-risk status: payment systems, banks, credit organizations, some bookmakers: to receive SMS from telecom operators: for </p>
            </div>
        </footer>
    );
};
