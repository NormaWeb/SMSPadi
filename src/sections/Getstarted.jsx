        ...
        <section className="max-container max-sm:mt-0">
            ...
            <div className="flex max-lg:flex-col gap-10 mt-10">
                ...
                <div className="flex flex-1 flex-col ">
                    ...
                    />
                    <h4 className='text-primary text-2xl max-sm:font-semibold max-sm:text-xl font-semibold'>1. Create an account </h4>
                ...
                <div className="flex flex-1 flex-col">
                    <img src={Icon2} alt="Fund your wallet"
                        ...
                        className="object-contain mb-3"
                    />
                    <h4 className='text-primary text-2xl mt-3 max-sm:font-semibold max-sm:text-xl font-semibold'>2. Fund your wallet </h4>
                ...
                <div className="flex flex-1 flex-col">
                    <img src={Icon3} alt="Start receiving SMS"
                        ...
                        className="object-contain mb-3"
                    />
                    <h4 className='text-primary text-2xl mt-3 max-sm:font-semibold max-sm:text-xl font-semibold'>3. Start receiving SMS </h4>
